...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        _renderer.canvasMargin = UIEdgeInsetsMake(ZLyScreenHeight * 0.3, 10, 10, 10);
...
- (void)setRelateLive:(ZLyLive *)relateLive
{
...
- (void)didFinish
{
    NSLog(@"加载状态...%ld %ld %s", (unsigned long)self.moviePlayer.loadState, (long)self.moviePlayer.playbackState, __func__);
